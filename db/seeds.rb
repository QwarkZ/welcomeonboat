...
boat_2 = Boat.create(
	...
	description: "Feeling 32 année 2003, c'est un quillard avec un tirant d'eau 1.65m, bi safran, électronique dernière génération simrad, GV X voiles, génois sur enrouleur neuf pour printemps 2017 de chez, habitable bien équipé et confortable. C'est le voilier idéal pour la navigation et la croisière en Finistère Sud, vers les Glénan, le Morbihan et ses îles (Groix, Belle-Île, Houat et Hoedic..)frigo neuf (juin 2018) N'hésitez pas à me laisser un message", 
	category: "Voilier", 
	price_per_day: "220", 
	address: "Loctudy", 
	owner: user_3
